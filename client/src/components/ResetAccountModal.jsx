...
export default function ResetAccountModal({handleToggleModal}) {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 bg-gray-700 opacity-80 flex items-center justify-center z-50">
        <div className="relative h-80 w-80 bg-100 flex flex-col items-center rounded-md md:h-[375px] md:w-[375px] z-[100]">
