  ...
  return (
    ...
    {isLabValuesOpen &&
        <div className="fixed top-14 right-0 bottom-14 w-80 bg-200 shadow-lg 2xl:w-[500px]">
            <h2 className="flex items-center pl-4 text-xl bg-400 h-20">Lab Values</h2>
            
            <AiFillCloseCircle className="absolute top-2 right-2 text-xl cursor-pointer hover:text-exam-secondary" onClick={() => setIsLabValuesOpen(!isLabValuesOpen)}/>

            <div className="bg-100 h-[152px] flex justify-center items-end text-xs border-b border-gray-500">
                <button 
            ...
            <div className="bg-blue-100 fixed top-72 right-0 bottom-14 w-80 2xl:w-[500px] p-4">
                ...
                {labData[dataIndex].values.map((value, index) => (
                    <div key={index} className="flex border-b border-100 py-1">
